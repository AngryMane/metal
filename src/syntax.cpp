...
#line 22 "rules/syntax.y" /* yacc.c:339  */
...
#line 87 "src/syntax.cpp" /* yacc.c:339  */
...
#line 5 "rules/syntax.y" /* yacc.c:355  */
...
#line 134 "src/syntax.cpp" /* yacc.c:355  */
...
union YYSTYPE
{
#line 43 "rules/syntax.y" /* yacc.c:355  */
...
{
  "$end", "error", "$undefined", "SYMBOL", "SEMICOLON", "TEXT", "INT_VAL",
  "FLOAT_VAL", "BOOL_VAL", "BRACKET_S", "BRACKET_E", "COLON", "BRACE_S",
  "BRACE_E", "DEF", "COMMA", "PLUS", "MINUS", "ASTER", "SLASH", "EQUAL",
  "VAR_INIT_DEF", "PROJECTION_ARROW", "PARENTHESE_S", "PARENTHESE_E",
...
do                                                              \
  if (yychar == YYEMPTY)                                        \
    ...
    {                                                           \
      yyerror (parse_context, ret, YY_("syntax error: cannot back up")); \
      YYERROR;                                                  \
    }                                                           \
while (0)
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, ParseContext& parse_context, BaseAST** ret)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (parse_context);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, ParseContext& parse_context, BaseAST** ret)
{
  YYFPRINTF (yyoutput, "%s %s (",
             yytype < YYNTOKENS ? "token" : "nterm", yytname[yytype]);

  yy_symbol_value_print (yyoutput, yytype, yyvaluep, parse_context, ret);
  YYFPRINTF (yyoutput, ")");
}
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int yyrule, ParseContext& parse_context, BaseAST** ret)
{
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, Rule, parse_context, ret); \
} while (0)
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, ParseContext& parse_context, BaseAST** ret)
{
  YYUSE (yyvaluep);
  YYUSE (parse_context);
  YYUSE (ret);
...
int
yyparse (ParseContext& parse_context, BaseAST** ret)
{
    int yystate;
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (parse_context, ret, YY_("syntax error"));
#else
# define YYSYNTAX_ERROR yysyntax_error (&yymsg_alloc, &yymsg, \
                                        yyssp, yytoken)
      {
        ...
        yyerror (parse_context, ret, yymsgp);
      ...
      if (yychar <= YYEOF)
      ...
      else
        {
          yydestruct ("Error: discarding",
                      yytoken, &yylval, parse_context, ret);
          yychar = YYEMPTY;
        }
    }
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  yystos[yystate], yyvsp, parse_context, ret);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (parse_context, ret, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  yystos[*yyssp], yyvsp, parse_context, ret);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
